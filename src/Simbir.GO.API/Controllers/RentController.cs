...
public class RentController : ControllerBase
{
    ...
    [Authorize]
    public async Task<IActionResult> Start(long transportId, [FromQuery] StartRentParams @params)
    {
    ...
    [Authorize]
    public async Task<IActionResult> End(long rentId, [FromQuery] EndRentParams @params)
    {
