...
namespace Simbir.GO.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231031185121_Initial")]
            ...
            modelBuilder.Entity("Simbir.GO.Domain.Transports.Transport", b =>
                {
                    ...
                    b.Property<long>("TransportOwnerId")
                        .HasColumnType("bigint")
                        .HasColumnName("transport_owner_id");
                    ...
                    b.HasIndex("TransportOwnerId")
                        .HasDatabaseName("ix_transports_transport_owner_id");

                    b.ToTable("transports", (string)null);
                });

            modelBuilder.Entity("Simbir.GO.Server.ApplicationCore.Auth.RevokedToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("AccountId")
                        .HasDatabaseName("ix_revoked_tokens_account_id");
            ...
            modelBuilder.Entity("Simbir.GO.Domain.Transports.Transport", b =>
                {
                    b.HasOne("Simbir.GO.Domain.Accounts.Account", "Account")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_transports_accounts_account_temp_id1");

                    b.OwnsOne("Simbir.GO.Domain.Transports.ValueObjects.Location", "Location", b1 =>
                        {
            ...
            modelBuilder.Entity("Simbir.GO.Server.ApplicationCore.Auth.RevokedToken", b =>
                {
                    b.HasOne("Simbir.GO.Domain.Accounts.Account", "Account")
                        .WithMany()
                        .HasForeignKey("AccountId")
                        .HasConstraintName("fk_revoked_tokens_accounts_account_id");
